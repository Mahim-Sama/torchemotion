...
datasets = {
    'train': IemocapDataset(r"M:\SOL\Sentiment_detection\IEMOCAP\IEMOCAP_full_release", sessions=[1, 2, 4, 5]),
    'val': IemocapDataset(r"M:\SOL\Sentiment_detection\IEMOCAP\IEMOCAP_full_release", sessions=[3])
}
...
dataloaders = { x: torch.utils.data.DataLoader(datasets[x], 
                                               ...
                                               shuffle=True, 
                                               num_workers=4, 
                                               collate_fn=IemocapDataset.collate_fn) for x in ['train', 'val'] }
# dataloaders = { x: torch.utils.data.DataLoader(datasets[x], 
#                                                batch_size=128, 
#                                                shuffle=(x=='train'), 
#                                                num_workers=4, 
#                                                collate_fn=IemocapDataset.collage_fn_vgg) for x in ['train', 'val'] }
